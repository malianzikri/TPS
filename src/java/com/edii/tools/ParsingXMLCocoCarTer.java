 ...
 */
public class ParsingXMLCocoCarTer {
        ...
        try {
            ...
            if (fStream != null) {
                try {
                    ...
                    List list = rootNode.getChildren("COCOCAR");
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        for (int j = 0; j < header.size(); j++) {
                            ...
                            try {
                                ...
                                exc.ExcuteError(e.getMessage(), "execute_class_ParsingXMLCocoCarter", result);
                            ...
                            for (int l = 0; l < car.size(); l++) {
                                ...
                                try {
                                    if (condition) {
                                        ...
                                        preparedStatement.setString(7, TGL_BC11);
                    ...
                    if (condition) {
                        ...
                        result = "Error " + mydb.executeError(query);
                        try {
            ...
            exc.ExcuteError(ex.getMessage(), "execute_class_ParsingXMLCocoCarter", result);
