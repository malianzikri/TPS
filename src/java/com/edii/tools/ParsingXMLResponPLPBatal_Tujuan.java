 ...
 */
public class ParsingXMLResponPLPBatal_Tujuan {
    ...
    public String parseDocumentPLPBatalTujuan(String fStream) throws Exception {
        ...
        try {
                ...
                try {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        for (int j = 0; j < header.size(); j++) {
                            ...
                            query = "INSERT INTO T_BATAL_PLP(RESPONID,KD_KANTOR,KD_TPS,KD_TPS_ASAL,NO_BATAL_PLP,TGL_BATAL_PLP,RECEIVED_DATE,NO_PLP,TGL_PLP)"
                            ...
                            preparedStatement.setString(8, NO_PLP);
                            preparedStatement.setDate(9, java.sql.Date.valueOf(TGL_PLP));
                        ...
                        for (int k = 0; k < detil.size(); k++) {
                            ...
                            for (int l = 0; l < kms.size(); l++) {
                                ...
                                query = "INSERT INTO T_BATAL_PLP_KMS(RESPONID,JNS_KMS,JML_KMS,NO_BL,TGL_BL)"
                                        + "VALUES (?,?,?,?,TO_DATE(?,'YYYYMMDD'))";
                            ...
                            for (int l = 0; l < cont.size(); l++) {
                                ...
                                query = "INSERT INTO T_BATAL_PLP_CONT(RESPONID,NO_CONT,UK_CONT)"
                                        + "VALUES (?,?,?)";
                    ...
                    preparedStatement.setString(3, tgl.getNow("yyyyMMddhhms"));
            ...
            exc.ExcuteError(ex.getMessage(), "execute_class_ParsingXMLPLPBatal_Tujuan", result);
