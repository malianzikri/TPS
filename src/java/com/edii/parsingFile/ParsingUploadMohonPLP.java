...
public class ParsingUploadMohonPLP {
    ...
    public String parseDocument(String fStream) throws Exception {
        ...
        try {
            if (fStream != null) {
                String header = px.getStringParsingXml(fStream, "LOADPLP>HEADER", "KD_KANTOR,TIPE_DATA,KD_TPS_ASAL,REF_NUMBER,NO_SURAT,TGL_SURAT,GUDANG_ASAL,KD_TPS_TUJUAN,GUDANG_TUJUAN,KD_ALASAN_PLP,YOR_ASAL,YOR_TUJUAN,CALL_SIGN,NM_ANGKUT,NO_VOY_FLIGHT,TGL_TIBA,NO_BC11,TGL_BC11,NM_PEMOHON");
                String[] split_headers = header.split(";");
                for (String headersss : split_headers) {
                    ...
                    String detil_kms = px.getStringParsingXml(fStream, "LOADPLP>DETIL>KMS", "JNS_KMS,JML_KMS,NO_BL_AWB,TGL_BL_AWB");
                    ...
                    String detil_cont = px.getStringParsingXml(fStream, "LOADPLP>DETIL>CONT", "NO_CONT,UK_CONT");
